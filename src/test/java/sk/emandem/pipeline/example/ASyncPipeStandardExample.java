...
import sk.emandem.pipeline.core.pipe.AsynchronousPipe;
 ...
 *
 */
public class ASyncPipeStandardExample {
	...
	public static void main(String[] args) throws Exception{
		...
		IPipe readerPipe = new AsynchronousPipe(1000).addInputs(dataReader).addOutputs(processors);
		IPipe writerPipe = new AsynchronousPipe(1000).addInputs(processors).addOutputs(writer);
